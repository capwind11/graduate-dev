...
class Preprocess:
    ...
    def __init__(self, outputFileDir, inputFileDir, log_item_to_event_id_file, instances_file_path, label_file_path, normal_output, abnormal_output):
        self.outputFileDir = outputFileDir
        self.inputFileDir = inputFileDir
        self.log_item_to_event_id_file = inputFileDir + log_item_to_event_id_file
        self.instances_file_path = outputFileDir + instances_file_path
        self.label_file_path = inputFileDir + label_file_path
