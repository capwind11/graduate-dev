...
class Drain:
    ...
    def __init__(self,log_format,depth=4, st=0.4,
                 maxChild=100, rex=[],treeStoragePath=None):
        self.depth = depth - 2
        self.st = st
    ...
    '''
    def fit(self, inputFile='D:\\毕业设计\\loghub\\HDFS_1\\HDFS.log', outputFile='.\\data\\log_item_to_label.csv',
            isReconstruct=False):
