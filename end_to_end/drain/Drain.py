...
class Para:
	def __init__(self, rex=None, path='./', depth=4, st=0.4, maxChild=100, logName='\HDFS.log',removable=True,removeCol=None,savePath='./results/',saveFileName='template', saveTempFileName='logTemplates.txt'):
		self.path = path
		self.depth = depth-2
		self.st = st
